...
#=begin
  for i in 0..9
    for j in 0..9
      case $map_state[i][j]
      when "W"
        $item[10*i+j].image("./image/item/mapchip1_1.png")
=begin
      when "M"
        $item[10*i+j].image("./image/item/item_1.png")
      when "S"
        $item[10*i+j].image("./image/item/item_1.png")
      when "G"
        $item[10*i+j].image("./image/item/item_1.png")
...
=end
      when "0"
        $item[10*i+j].image("./image/item/mapchip.png")
      when "1".."9"
        $item[10*i+j].image("./image/item/item_#{$map_state[i][j].to_i}.png")
      end
    end
  end
#=end
